...
namespace Born\Deliveryboy\Model\Import;
 ...
 * Class Courses
 */
class DeliveryImport extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    const ENTITY_CODE = 'sales_order';
    ...
    {
        $name = $rowData['customer_firstname'] ?? '';
        $boy = $rowData['delivery_boy'] ?? '';
        ...
        if (!$boy) {
            $this->addRowError('BoyIsRequired', $rowNum);
        }
    ...
    private function initMessageTemplates()
    {
        ...
        $this->addMessageTemplate(
            'BoyIsRequired',
            __('The boy name cannot be empty.')
        );
    }
