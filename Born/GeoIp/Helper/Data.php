...
{
    const XML_PATH_ENABLED = 'born_geoip/born_geo_block/enable';
    const XML_PATH_ENABLED_REDIRECTION = 'born_geoip/born_geo_redirection/enable_geo_redirection';
    const XML_PATH_COUNTRIES = 'born_geoip/born_geo_block/countries';
    const XML_PATH_IP_BLACK_LIST = 'born_geoip/born_geo_block/ip_black_list';
    const XML_PATH_API_KEY = 'born_geoip/born_geo_block/api_key_ipstack';
