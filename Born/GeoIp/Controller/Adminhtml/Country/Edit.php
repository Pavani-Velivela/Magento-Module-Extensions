...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Born\GeoIp\Model\CountryFactory $countryFatory
    ) {
        $this->resultPageFactory = $resultPageFactory;
        $this->_coreRegistry = $registry;
        $this->countryFatory = $countryFatory;
    ...
    public function execute()
    {
        ...
        $model = $this->countryFatory->create();
        ...
        $this->_coreRegistry->register('country', $model);
         ...
         * Set Page title
         */
        $resultPage->getConfig()->getTitle()->prepend(__('countrymapping'));
